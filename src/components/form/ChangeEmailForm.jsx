            ...
            {({ isSubmitting }) => (
                <Form className="flex flex-col gap-5 text-white">
                    <div className='flex flex-col gap-2'>
                        <InputField name="email" type="email" placeholder="Masukkan email" customClassname="w-full" />
                        <p className='text-sm text-default-500'>Email akan berubah ketika Anda sudah memasukkan kode OTP untuk verifikasi yang dikirimkan ke email baru Anda.</p>
                    </div>
